...
public void transfer()
{
  ...
  Scanner sc = new Scanner(System.in);
  System.out.print("Enter Receipent's accout number : ");
...
try{
       if(balance >= 100000f)
       {
         ...
         { 
           ...
           System.out.println("\n"+amount+" Successfully Transfered to account "+ receipentName);
           String str=amount+" Rs Transfered to "+ receipentName+"\n";  
           transactionHistory=transactionHistory.concat(str);
         }
         else 
